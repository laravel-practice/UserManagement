...
<div class="container">
	<div class="sub_container">
		...
		<hr>
		<form class="form-horizontal" action="{{ url('UpdateUser/'.$single_data->id) }}" method="POST">
			@csrf
			<!--{{ csrf_field() }}-->
			<fieldset>
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="input-xlarge focused" value="{{ $single_data->address }}" type="text" name="address">
				</div>
			  </div>
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="input-xlarge focused" value="{{ $single_data->password }}" type="text" name="password">
				</div>
			  </div>
